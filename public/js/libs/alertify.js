  ...
  Alertify = function () {
    ...
    dialogs = {
      buttons : {
        ...
        ok     : "<a href=\"#\" class=\"alertify-button alertify-button-ok cupid-green no-title\" id=\"alertify-ok\">{{ok}}</a>",
        cancel : "<a href=\"#\" class=\"alertify-button alertify-button-cancel cupid-orange no-title\" id=\"alertify-cancel\">{{cancel}}</a>"
      },
    ...
    _alertify = {
      ...
      build : function (item) {
        ...
        case "confirm":
          ...
          if(accept && accept != "")  var acceptLabel = accept;
          else                        var acceptLabel = this.labels.ok;
          if(cancel && cancel != "")  var cancelLabel = cancel;
          else                        var cancelLabel = this.labels.cancel;          

          html = html.replace("{{ok}}", this.labels.ok).replace("{{cancel}}", cancelLabel);
          break;
        case "prompt":
        ...
        case "alert":
          ...
          html = html.replace("{{ok}}", acceptLabel);
          break;
        default:
          break;
        }
       ...
       * @return {Object}
       */
      dialog : function (message, accept, cancel, type, fn, placeholder, cssClass) {
        ...
        queue.push({ type: type, message: message, accept: accept, cancel: cancel, callback: fn, placeholder: placeholder, cssClass: cssClass });
    ...
    return {
      alert   : function (content, fn, cssClass) { _alertify.dialog( content['message'], content['accept'], "", "alert", fn, "", cssClass); return this; },
      confirm : function (content, fn, cssClass) { _alertify.dialog( content['message'], content['accept'], content['cancel'], "confirm", fn, "", cssClass); return this; },
