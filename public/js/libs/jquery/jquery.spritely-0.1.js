...
(function($) {
	$._spritely = {
		...
		animate: function(options) {
			...
			if( !el.hasClass("activeImportant") && this.stopped )return false;
	...
	$.fn.extend({
		spritely: function(options) {
            ...
            if (options.do_one_loop) {
				$(this).spriteIntervalX(function(){
					$._spritely.animate(options);
				}, get_rate(options.fps), options.no_of_frames);
		...
		spriteIntervalX: function(callback, delay, repetitions) {
			var x = 0;
